...
class NativeConfiguredRegionalSkin {
public:
  static constexpr const char* configuration_sha256="ad93aa3dcc4e9bcfeb54f076c7bbe76d316f0b2e6d52ec4865536a20e511aefb";
  static constexpr std::array<double,3> fractions{0.052809544820190298,0.052890723645319306,0.89429973153449038};
  static inline const std::array<std::string,3> regions{"engineered_left_lower_leg","engineered_right_lower_leg","engineered_exterior_complement"};
  ...
  NativeConfiguredRegionalSkin(SEFluidCircuit& circuit,SECompartmentManager& compartments,SELiquidCompartment& owner)
    :parent(owner) {
