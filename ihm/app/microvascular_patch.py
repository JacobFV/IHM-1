...
LIMITS={'max_request_bytes':32768,'max_capillaries':64,'max_edges':256,'max_zoom_samples':20000,'max_response_bytes':2097152,
        'min_resolution_m':5e-6,'max_resolution_m':1e-3,'max_extent_mm':2.,'max_parallel_queries':1}
...
class MicrovascularPatchService:
 ...
 def materialize(self,data):
  ...
  if not isinstance(entity,str) or entity not in REGIONS:raise PatchRequestError(422,'unsupported_region','Select left or right vastus lateralis')
  ...
  scenario_id=data.get('scenario_id','human_quadriceps_1988_corrected_v1')
