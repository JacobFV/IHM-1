...
VARIANTS = ('upstream', 'saturation_bounds', 'saturation_bounds_heatflux',
            ...
            'whole_body_integrity_gi_water', 'whole_body_integrity_energy', 'whole_body_integrity_depletion','whole_body_integrity_signed_muscle_v2')+THERMAL_RESEARCH_VARIANTS
