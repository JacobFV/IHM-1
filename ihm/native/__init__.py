...
class NativeConfig:
    ...
    def __post_init__(self):
        ...
        if self.engine_variant not in ('upstream','saturation_bounds','saturation_bounds_heatflux','saturation_bounds_heatflux_thermal_units','whole_body_integrity','whole_body_integrity_renal','whole_body_integrity_gi_water'):raise ValueError('Unknown engine variant')
...
def summarize(output_dir,config=None):
    ...
    if variant in ('saturation_bounds_heatflux','saturation_bounds_heatflux_thermal_units','whole_body_integrity','whole_body_integrity_renal','whole_body_integrity_gi_water'):
    ...
    if variant in ('saturation_bounds_heatflux_thermal_units','whole_body_integrity','whole_body_integrity_renal','whole_body_integrity_gi_water'):
    ...
    if variant in ('whole_body_integrity','whole_body_integrity_renal','whole_body_integrity_gi_water'):
    ...
    if variant in ('whole_body_integrity_renal','whole_body_integrity_gi_water'):
    ...
    if variant=='whole_body_integrity_gi_water':
