...
BASE='data/derived/mechanics/patient_rightlift_anchored_stance98/registration.json'
SEED='data/derived/mechanics/patient_rightlift_anchored_stance98/registration.json'
OUT=ROOT/'data/derived/mechanics/patient_rightswing_stance98'
...
def main():
    ...
    def coordinates(x):
        ...
        q.update(hip_flexion_r=.5, knee_angle_r=.6, ankle_angle_r=float(a)+.1)
        return q
