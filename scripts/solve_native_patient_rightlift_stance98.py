...
BASE='data/derived/mechanics/patient_left95_stance98/registration.json'
SEED='data/derived/mechanics/patient_left95_stance98/registration.json'
OUT=ROOT/'data/derived/mechanics/patient_rightlift_stance98'
...
def main():
    ...
    def coordinates(x):
        ...
        q.update(hip_flexion_r=.125, knee_angle_r=.25, ankle_angle_r=float(a)+.125)
        return q
