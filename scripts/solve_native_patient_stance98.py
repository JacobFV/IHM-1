...
SEED='data/derived/mechanics/resting_stance98/registration.json'
OUT=ROOT/'data/derived/mechanics/patient_stance98'
...
def main():
    ...
    native=NativeMechanicalStream(ROOT,work/'native',environment='upright',target_mass_kg=TARGET_MASS_KG,augmented_registration=BASE)
