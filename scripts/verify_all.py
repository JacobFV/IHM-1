...
commands += [[sys.executable,'scripts/'+name] for name in ['verify_clothing.py','verify_garment_remesh.py','verify_material_domains.py','verify_contact_dynamics.py','verify_body_reflexes.py','verify_textile.py','verify_systemic_experiments.py','verify_systemic_evidence.py','verify_systemic_projection.py']]
