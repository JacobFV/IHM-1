...
def build():
    ...
    paths=[source,header,surface_header,out/surface_header.name,pose_header,out/pose_header.name,out/'native_mechanical_stream',retained,out/header.name]+library_paths
