...
BASE='data/derived/mechanics/patient_stagger_right80_refined_stance98/registration.json'
SEED='data/derived/mechanics/patient_stagger_right80_refined_stance98/registration.json'
OUT=ROOT/'data/derived/mechanics/patient_stagger_right80_freehips_stance98'
...
def main():
    ...
    try:
        for outer in range(3):
            solved=least_squares(pose_residual,x,bounds=bounds,x_scale='jac',jac=pose_jacobian,max_nfev=40,xtol=1e-10,ftol=1e-10,gtol=1e-9)
