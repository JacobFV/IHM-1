...
- Total base-model segment mass is **85.26984854173146 kg**, compared with **75.337 kg** for retained Rajagopal2016 and the canonical mass target **70.7713 kg** (**77.1107029 kg** when this audit was written; the profile now carries the mass composed over the acquired geometry). Establish one explicit physical subject/mass partition before feedback coupling.
