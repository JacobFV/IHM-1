...
export const MONITORS = [
  ...
  {id:'skin-voltage',title:'Bulk Skin tissue Vm',description:'Native Skin tissue intracellular-to-extracellular membrane potential in mV, with actual live samples.',tags:['live','physiology','skin','signals','voltage']},
...
export function mountMonitors() {
  ...
  const liveContents={};
  for(const id of ['live','motor','intake','intake-mass','skin-voltage','temporal-spectrum','microvascular','live-signal-1','live-signal-2','live-signal-3']){
